      ...
      {loading ? (
        ...
        <div className="flex gap-8 justify-center items-center flex-wrap-reverse h-[80vh]">
          <div className="social-handles hidden lg:inline-block space-y-5 text-center">
            ...
            <p className="text-zinc-400">Email us on &nbsp; <a href="mailto:rpa.techclub@kluniversity.in" className="bg-slate-700 p-2 text-white rounded">rpa.techclub@kluniversity.in</a></p>
          </div>
